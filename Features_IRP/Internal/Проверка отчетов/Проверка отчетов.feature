...
Сценарий: _0902 проверка отчета Информация по номенклатуре
	...
	// сравнение определенной ячейки (так же можно и делать сравнение областей через область)
...
Сценарий: _0903 проверка отчета по Закупкам
	...
	Дано Табличный документ "Result" равен макету "Закупки33333" по шаблону
