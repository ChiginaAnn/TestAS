...
//	И Я запоминаю в переменную "СоединениеУстановленно" значение "Нет"
//	И я делаю 2 раз
//		Попытка
//			И я нажимаю на кнопку "Получить данные"
//			И элемент формы с именем "ГодВысокосный" стал равен "Да"
//			И Я запоминаю в переменную "СоединениеУстановленно" значение "Да"
//			Тогда я прерываю цикл
//		Исключение 
//			И Пауза 10
//	Если переменная "СоединениеУстановленно" имеет значение "Нет" Тогда
